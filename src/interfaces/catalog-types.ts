...
export const svgCheckActive =
  "<svg xmlns='http://www.w3.org/2000/svg' width='25' height='24' fill='#666'><path fill-rule='evenodd' d='M12.928 0c-9.6 0-12 2.4-12 12s2.4 12 12 12 12-2.4 12-12-2.4-12-12-12' clip-rule='evenodd'/><path stroke='#fff' stroke-width='2.325' d='m6.511 11.121 4.203 4.665 8.63-9.354'/></svg>";

export const svgCheckInactive =
  "<svg xmlns='http://www.w3.org/2000/svg' width='25' height='24' fill='none' stroke='#666'><path stroke-width='3' d='M12.928 1.5c-4.81 0-7.216.638-8.54 1.96-1.322 1.324-1.96 3.73-1.96 8.54s.638 7.216 1.96 8.54c1.324 1.322 3.73 1.96 8.54 1.96 4.811 0 7.217-.638 8.54-1.96 1.323-1.324 1.96-3.73 1.96-8.54s-.637-7.216-1.96-8.54c-1.323-1.322-3.729-1.96-8.54-1.96Z'/></svg>";
